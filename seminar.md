...
# 1.3 Почему количество документов меньше количества вхождений? Ответ: Потому что в одном документе может быть несколько вхождений. 
```
### 2. IPM
...
```
# 7.1 Прилагательные: багровая ярость, белая зависть, что-то там...
```
